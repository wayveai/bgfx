...
#define JS_EVENT_INIT   0x80 /* initial state of device */
	...
	struct Context
	{
		...
		int32_t run(int _argc, const char* const* _argv)
		{
			...
			int length = 2 + 32 * 32;
			XChangeProperty(m_display, m_window[0], net_wm_icon, cardinal, 32, PropModeReplace, (const unsigned char*) iconBuffer, length);
#endif
